...
$(document).ready(() => {
  const links = [
    {
      name: 'my discord',
      link: 'https://discord.com/channels/@me/1099600375486611508',
    },
    {
      name: 'spotify',
      link: 'open.spotify.com/user/31muqwozablor4xy4loqsknbd4le?si=3e9a0d42118345f9',
    },
    {
      name: 'feds.lol',
      link: 'feds.lol/endo',
    ...
    {
      name: 'roblox',
      link: 'https://www.roblox.com/users/501304530/profile',
    }
  ];
  ...
  app.titleChanger(['e', 'en', 'end', 'endo', 'endo $']);
  app.iconChanger(['e/assets/others/pfp.png', 'e/assets/others/pfp.png', 'e/assets/others/pfp.png', 'e/assets/others/pfp.png', 'e/assets/others/pfp.png', 'e/assets/others/pfp.png', 'e/assets/others/pfp.png', 'e/assets/others/pfp.png', 'e/assets/others/pfp.png']);
});
...
$.getJSON(ipgeolocation, (data) => {
  writeLine(['Authenticating...', "Granting access to <span style='font-size: 14px; color: #06d;'>[unknown]</span>..."], 30, () => {
    ...
    writeLine([`Access granted! <span style='font-size: 14px; color: #0f0;'>[success]</span>`, `Welcome back, <i style='color: #0f0'>${ip}</i>! By the way, nice to see someone from ${country} here!`], 30, 500, () => {
      ...
      writeLine([`<i style='color: #F62459'>Endo#0002 </i>`], 120, 500, () => {
        timeouts.push(
          setTimeout(() => {
            if (app.skippedIntro) return;
