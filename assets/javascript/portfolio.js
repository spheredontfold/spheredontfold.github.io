...
$(document).ready(() => {
  const links = [
    {
      name: 'my discord',
      link: 'discord.com/channels/@me/1073567429504008292',
    },
    {
      name: 'spotify',
      link: 'open.spotify.com/user/yskuosumbribq9qnjrszh4u43',
    },
    {
      name: 'feds.lol',
      link: 'feds.lol/hu',
  ...
  app.titleChanger(['h', 'hu', 'huk', 'hukz', 'hukz $']);
  app.iconChanger(['assets/others/swagdoggo.jpg', 'assets/others/swagdoggo.jpg', 'assets/others/swagdoggo.jpg', 'assets/others/swagdoggo.jpg', 'assets/others/swagdoggo.jpg', 'assets/others/swagdoggo.jpg', 'assets/others/swagdoggo.jpg', 'assets/others/swagdoggo.jpg', 'assets/others/swagdoggo.jpg']);
});
...
$.getJSON(ipgeolocation, (data) => {
  writeLine(['Authenticating...', "Granting access to <span style='font-size: 14px; color: #06d;'>[unknown]</span>..."], 30, () => {
    ...
    writeLine([`Access granted! <span style='font-size: 14px; color: #0f0;'>[success]</span>`, `Welcome back, <i style='color: #0f0'>${ip}</i>! By the way, nice to see someone from ${country} here!`], 30, 500, () => {
      ...
      writeLine([`<i style='color: #F62459'>hukz#0001 </i>`], 120, 500, () => {
        timeouts.push(
          setTimeout(() => {
            if (app.skippedIntro) return;
