...
$(document).ready(() => {
  const links = [
    {
      name: 'my discord',
      link: 'https://discord.com/channels/@me/1099305429760225395',
    },
    {
      name: 'github',
      link: 'https://github.com/DotQuaz',
    },
    {
      name: 'feds.lol',
      link: 'https://feds.lol/quaz',
    },
    {
      name: 'roblox',
      link: 'https://www.roblox.com/users/4286324994/profile',
    }
  ];
  ...
  app.titleChanger(['d', 'do', 'dot', 'dot $', 'dot', 'do', 'd']);
...
$.getJSON(ipgeolocation, (data) => {
  writeLine(['Authenticating...', "Granting access to <span style='font-size: 14px; color: #06d;'>[unknown]</span>..."], 30, () => {
    ...
    writeLine([`Access granted! <span style='font-size: 14px; color: #0f0;'>[success]</span>`, `Welcome back, <i style='color: #0f0'>${ip}</i>! By the way, nice to see someone from ${country} here!`], 30, 500, () => {
      ...
      writeLine([`<i style='color: #F62459'>dot#0653 </i>`], 120, 500, () => {
        timeouts.push(
          setTimeout(() => {
            if (app.skippedIntro) return;
